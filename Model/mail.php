...
class Mail extends DATABASE{
    ...
    public function activarUserMail($user)
    {
        ...
        try {
            ...
            $mail->Body  .= '<br> <a href="http://'.$_SERVER["SERVER_NAME"].'/ruteador.php?controller=Mail&action=activarUser&key=' . $usuario->getByUser($user)->PASSWORD . '>Enlace de Verificacion</a>  ';
